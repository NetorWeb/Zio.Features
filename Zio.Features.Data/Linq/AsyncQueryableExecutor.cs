...
namespace Zio.Features.Data.Linq;

public class AsyncQueryableExecutor : IAsyncQueryableExecutor, ISingletonDependency
{
    protected IEnumerable<IAsyncQueryableProvider> Providers { get; }

    public AsyncQueryableExecutor(IEnumerable<IAsyncQueryableProvider> providers)
    {
        Providers = providers;
    }
